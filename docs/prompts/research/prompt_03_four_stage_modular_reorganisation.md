...
You have already reviewed several deep-research reports for **NLPCC 2026 Shared Task 4: “LLM-based Investment Advisor Agents for Asset Allocation in the Chinese Market.”**
...
Raw Top-20 news → structured textual signals.
...
Structured textual signals → a persistent or queryable quantitative representation.
...
Official price and portfolio data → quantitative market state.
...
Text state + trade state → target weights / official trades.
...
Construct 5–7 final modular system designs.
...
### Phase 0R — Reset and Data Contract

### Phase 1R — Official Starter Reproduction

### Phase 2R — Stage 3 Trade Data Processing + S0/S1 Baselines

Build trade data processing before fancy news.

### Phase 3R — Stage 1 News Processing MVP

Build event extraction and schema validation.

### Phase 4R — Stage 2 Text Storage MVP
...
### Phase 6R — Integrated Modular Systems and Ablations

Compare modular combinations.

### Phase 7R — A-list Package and B-list Hardening
