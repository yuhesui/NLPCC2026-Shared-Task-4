# Open Questions 鈥?NLPCC 2026 Shared Task 4
...
9. Which report artifacts should be generated by `src/tools/reporting/`, and which lightweight wrapper scripts should live under `scripts/`?
...
5. How should news-derived confidence be mapped into `惟_t` for Black-Litterman?
...
1. What exact input object should the official wrapper pass into `src/nlpcc/` each day?
