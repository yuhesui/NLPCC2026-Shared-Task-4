...
Do not place executable production logic under `docs/`. Reusable competition modules live under `src/nlpcc/`; local research and development tools live under `src/tools/`; thin command wrappers live under `scripts/`.
